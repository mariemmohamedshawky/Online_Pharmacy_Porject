    ...
    <div class="container">
        ...
        <form   action="{{url('/insert_product')}}" class="mbr-form" method="get">
                        <div class="input-wrap" data-for="email">
                            ...
                            <input type="name" class="form-control" name="name" data-form-field="Email" required="" id="email-form4-1">
                        </div>
                            
                            <div class="input-wrap" data-for="email">
                            <label class="form-label-outside mbr-lighter" for="form-1-email">Price:</label>
                            <input type="name" class="form-control" name="price" data-form-field="Email" required="" id="email-form4-1">
                        </div>
                        
                    
                        <div class="input-wrap" data-for="email">
                            <label class="form-label-outside mbr-lighter" for="form-1-email">Description:</label>
                            <input type="name" class="form-control" name="des" data-form-field="Email" required="" id="email-form4-1">
                        </div>
                     <div class="input-wrap" data-for="email">
                            <label class="form-label-outside mbr-lighter" for="form-1-email">ExpireDate:</label>
                            <input type="name" class="form-control" name="expire_date" data-form-field="Email" required="" id="email-form4-1">
                        </div>
