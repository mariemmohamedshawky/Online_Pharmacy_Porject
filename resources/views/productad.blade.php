...
<div class="row justify-content-around">
   @foreach ($products as $product)
        ...
        <div class="col-lg-2 col-md-3 col-sm-6 col-6" style=" height:470px;">
            ...
            <div class="card" style="width: 18rem;height:400px; margin:20px;box-shadow:0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);background-color: #000000;opacity: 90%; border-radius: 35px;">
