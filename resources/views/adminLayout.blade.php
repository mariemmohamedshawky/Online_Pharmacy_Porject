    ...
    <ul class="navbar-nav mr-auto">
     ...
     @else
      <li class="nav-item">
       ...
       <form class="navbar-form" role="search_admin" method="get" action="/search_admin"  >
   <div class="input-group">
   <input type="text" clss="form-control" placeholder="search" name="titlea">
    <div class=input-group-btn>
        <button class="btn btn-default" type="submit">
            
            <i class="glyphicon glyphicon-search_admin"></i>
        </button>
    </div>
...
<h5 class="widget-title">Orginization  NAME<span></span></h5>
<p>Life Pharmacy . </p>
</div>
</div>
...
<p>TO be A member in our website?.</p>
<a class="btn" href="{{url('register/')}}" target="_blank">Register Now</a>
</div>
</div>
